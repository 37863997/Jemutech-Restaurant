...
def sales_admin(request):
    return render(request, 'hotel/sales.html')
...
def users_admin(request):
    ...
    print(customers)
    return render(request, 'hotel/users.html', {'users':customers})
...
def orders_admin(request):
    ...
    print(dBoys)
    return render(request, 'hotel/orders.html', {'orders':orders, 'dBoys':dBoys})

@login_required
@staff_member_required
def foods_admin(request):
    foods = Food.objects.filter()
    return render(request, 'hotel/foods.html', {'foods':foods})

@login_required
@staff_member_required
def sales_admin(request):
    sales = Data.objects.filter()
    return render(request, 'hotel/sales.html', {'sales':sales})
...
def add_user(request):
    if request.method == "POST":
        ...
        if (first_name == "") or (last_name == "") or (address == "") or (contact == "") or (email == "") or (password == "") or (confirm_pass == ""):
            ...
            return render(request, 'hotel/users.html', {'users': customers, 'error_msg': error_msg})
        ...
        if password == confirm_pass:
            ...
            customers = Customer.objects.filter()
            return render(request, 'hotel/users.html', {'users': customers, 'success_msg': success_msg})
...
def add_food(request):
    if request.method == "POST":
        ...
        if (name == "") or (course is None) or (status is None) or (content == "") or (base_price == "") or (discount == ""):
            foods = Food.objects.filter()
            error_msg = "Please enter valid details"
            return render(request, 'hotel/foods.html', {'foods': foods, 'error_msg': error_msg})
        ...
        return render(request, 'hotel/foods.html', {'foods': foods, 'success_msg': success_msg})
    return redirect('hotel:foods_admin')
...
def add_sales(request):
    if request.method == "POST":
        ...
        if (date is None) or (sales == "") or (expenses == ""):
            sales = Data.objects.filter()
            error_msg = "Please enter valid details"
            return render(request, 'hotel/sales.html', {'sales': sales, 'error_msg': error_msg})
        ...
        return render(request, 'hotel/sales.html', {'sales': datas, 'success_msg': success_msg})
